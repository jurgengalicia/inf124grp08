        ...
        <ul id="top-nav-header-list">
          ...
          <li class="nav-dropdown">
            ...
            <div class="nav-dropdown-content">
              <a href="soft_serve.html">Soft Serve</a>
              <a href="popsicle.html">Popsicles</a>
              <a href="shaved_ice.html">Shaved Ice</a>
            </div>
          </li>
        ...
        <form name="productForm" action="javascript:sendEmailOnPurchase()">
          <div>
            ...
            <div class="form-info">
              ...
              <input type="email" name="EmailAddress" value="" placeholder="benjerrys@icecream.com">
            </div>
          </div>
          <div>
            <div class="form-info">
            ...
            <div class="form-info">
              ...
              <input type="text" name="ShippingAddress" value="" placeholder="1234 Salty Springs">
            </div>
            <div class="form-info">
              <div class="form-info-name">
                Shipping Method:
